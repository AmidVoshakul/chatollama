    ...
    return (
        <div
            ...
            <p className="text-gray-400 mb-6 text-center max-w-md">
                Проверь, что сервер запущен и API возвращает данные. Попробуй перезагрузить страницу или создать новый
                чат.
            </p>
            <button
                onClick={onRetry}
                className="px-4 py-2 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-md hover:opacity-90 transition"
            >
                🔄 Перезагрузить
            </button>
        </div>
